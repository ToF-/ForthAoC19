...
T{ ." WIRE>LINE>CELLS store wire lines as cells" CR
    CREATE A-LINE-CELLS 4 CELLS ALLOT
    WIRES A-LINE-CELLS 4 WIRE>LINE>CELLS
    A-LINE-CELLS 0 CELLS + LINE@    RIGHT-DIR 0 0 8     4 N?S
    A-LINE-CELLS 1 CELLS + LINE@    UP-DIR    8 0 5     4 N?S
    A-LINE-CELLS 2 CELLS + LINE@    LEFT-DIR  5 3 8     4 N?S
    A-LINE-CELLS 3 CELLS + LINE@    DOWN-DIR  3 2 5     4 N?S
}T
...
T{ ." INTERSECTION? find an intersection between two orthogonal lines" CR
    ...
    A-LINE-CELLS 4 B-LINE-CELLS 4 INTERSECTIONS!
...
T{ ." DISTANCE computes manhattan distance to 0 0 " CR
    5 4 DISTANCE 9 ?S
    -5 4 DISTANCE 9 ?S
    2 -2 DISTANCE 4 ?S
    -1 -1 DISTANCE 2 ?S
...
T{ ." FIND-CLOSEST-INTERSECTION find closests intersection" CR
    A-LINE-CELLS 4 B-LINE-CELLS 4 INTERSECTIONS!
    FIND-CLOSEST-INTERSECTION
    CLOSEST-INTERSECTION 2@  3 3 2 N?S
}T
...
CREATE PUZZLE-A-LINE-CELLS PUZZLE-A-WIRE-SIZE @ CELLS ALLOT
CREATE PUZZLE-B-LINE-CELLS PUZZLE-B-WIRE-SIZE @ CELLS ALLOT
PUZZLE-A-WIRE PUZZLE-A-LINE-CELLS PUZZLE-A-WIRE-SIZE @ WIRE>LINE>CELLS
PUZZLE-B-WIRE PUZZLE-B-LINE-CELLS PUZZLE-B-WIRE-SIZE @ WIRE>LINE>CELLS
PUZZLE-A-LINE-CELLS PUZZLE-A-WIRE-SIZE @ PUZZLE-B-LINE-CELLS PUZZLE-B-WIRE-SIZE @ INTERSECTIONS!

T{ ." solve puzzle03a" CR
    FIND-CLOSEST-INTERSECTION
    CLOSEST-INTERSECTION 2@  DISTANCE 258 ?S
}T

T{ ." INCLUDE-COORDS? tell if a line contains a point and at what distance" CR
    0 0 A-LINE-CELLS 0 CELLS + LINE@ INCLUDE-COORDS? TRUE ?S 0 ?S
    0 3 A-LINE-CELLS 0 CELLS + LINE@ INCLUDE-COORDS? TRUE ?S 3 ?S
    0 8 A-LINE-CELLS 0 CELLS + LINE@ INCLUDE-COORDS? TRUE ?S 8 ?S
    0 9 A-LINE-CELLS 0 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S
   0 -3 A-LINE-CELLS 0 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S
   -5 3 A-LINE-CELLS 0 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S
    5 3 A-LINE-CELLS 0 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S

    0 8 A-LINE-CELLS 1 CELLS + LINE@ INCLUDE-COORDS? TRUE ?S 0 ?S
    3 8 A-LINE-CELLS 1 CELLS + LINE@ INCLUDE-COORDS? TRUE ?S 3 ?S
    5 8 A-LINE-CELLS 1 CELLS + LINE@ INCLUDE-COORDS? TRUE ?S 5 ?S
   -5 8 A-LINE-CELLS 1 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S
    7 8 A-LINE-CELLS 1 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S
    3 7 A-LINE-CELLS 1 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S
    3 9 A-LINE-CELLS 1 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S

    5 8 A-LINE-CELLS 2 CELLS + LINE@ INCLUDE-COORDS? TRUE ?S 0 ?S
    5 6 A-LINE-CELLS 2 CELLS + LINE@ INCLUDE-COORDS? TRUE ?S 2 ?S
    5 3 A-LINE-CELLS 2 CELLS + LINE@ INCLUDE-COORDS? TRUE ?S 5 ?S
    5 2 A-LINE-CELLS 2 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S
    5 9 A-LINE-CELLS 2 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S
    -5 6 A-LINE-CELLS 2 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S
    5 -2 A-LINE-CELLS 2 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S

    5 3 A-LINE-CELLS 3 CELLS + LINE@ INCLUDE-COORDS? TRUE ?S 0 ?S
    3 3 A-LINE-CELLS 3 CELLS + LINE@ INCLUDE-COORDS? TRUE ?S 2 ?S
    2 3 A-LINE-CELLS 3 CELLS + LINE@ INCLUDE-COORDS? TRUE ?S 3 ?S
   -5 3 A-LINE-CELLS 3 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S
    7 3 A-LINE-CELLS 3 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S
    5 7 A-LINE-CELLS 3 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S
    3 9 A-LINE-CELLS 3 CELLS + LINE@ INCLUDE-COORDS? FALSE ?S
}T

T{ ." INCLUDE-INTERSECTION? tell if a line contains one of the intersections and at what distance" CR
    
    A-LINE-CELLS 4 B-LINE-CELLS 4 INTERSECTIONS!
    A-LINE-CELLS 0 CELLS + LINE@ dbg INCLUDE-INTERSECTION? FALSE ?S
    A-LINE-CELLS 2 CELLS + LINE@ INCLUDE-INTERSECTION? TRUE ?S 2 ?S
}T
BYE
