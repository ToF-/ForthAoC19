...
." @INTERSECTS! stores an intersection step value at wires which intersect" CR
...
." INTERSECTIONS! finds and stores all intersections" CR
    WIRES CIRCUIT-C
    \ R8,U5,L5,D3,
    8 WIRE-R, 5 WIRE-U, 5 WIRE-L, 3 WIRE-D,
    END-WIRES
    ...
    7 WIRE-U, 6 WIRE-R, 4 WIRE-D, 4 WIRE-L,
    END-WIRES
    CIRCUIT-C CIRCUIT-D INTERSECTIONS!
    CIRCUIT-C 3 CELLS + @ CELL>WIRE 15 ?S DROP 2DROP
    CIRCUIT-D 4 CELLS + @ CELL>WIRE 20 ?S DROP 2DROP
    #INTERSECTIONS @ 2 ?S

." CLOSEST finds the closest intersection found in the last search" CR
    FIND-CLOSEST 6 ?S

." SOLVE PUZZLE 03A" CR
    WIRES CIRCUIT-03-A
75 WIRE-R, 30 WIRE-D, 83 WIRE-R, 83 WIRE-U, 12 WIRE-L, 49 WIRE-D, 71 WIRE-R, 7 WIRE-U, 72 WIRE-L,
END-WIRES
    WIRES CIRCUIT-O3-B
62 WIRE-U, 66 WIRE-R, 55 WIRE-U, 34 WIRE-R, 71 WIRE-D, 55 WIRE-R, 58 WIRE-D, 83 WIRE-R,
END-WIRES
    CIRCUIT-03-A CIRCUIT-O3-B INTERSECTIONS!
    FIND-CLOSEST 159 ?S
