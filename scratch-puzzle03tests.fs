...
: .LINE ( addr -- )
    LINE@ 2SWAP SWAP . . SWAP . . ;

T{ ." INTERSECTION-LINES keep track of intersections" CR
   A-LINE-CELLS 4 B-LINE-CELLS 4 INTERSECTIONS!
   MAX-INTERSECTION @ 3 ?S
   INTERSECTIONS 0 CELLS + @ CELL>COORDS . . ." -- " INTERSECTION-LINES 0 2* CELLS + 2@ SWAP . . CR
   INTERSECTIONS 1 CELLS + @ CELL>COORDS . . ." -- " INTERSECTION-LINES 1 2* CELLS + 2@ SWAP . . CR
   INTERSECTIONS 2 CELLS + @ CELL>COORDS . . ." -- " INTERSECTION-LINES 2 2* CELLS + 2@ SWAP . . CR
}T
